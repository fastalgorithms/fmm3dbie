...
c
c
      subroutine dquadints(eps,istrat,intype,npatches,norder,
     1     ipoly,ttype,npols,
...
c
      ...
      if(istrat.eq.1) then
          rn1 = 0
          n2 = 0
          call dquadints_dist(eps,intype,npatches,norder,ipoly,
     ...
     3        dpars,ndz,zpars,ndi,ipars,nqorder,rfac,cintvals,ier)
      ...
      if(istrat.eq.2) then
          rn1 = 0
          n2 = 0
          call dquadints_adap(eps,intype,npatches,norder,ipoly,ttype,
     ...
     3        ipars,nqorder,cintvals)
      ...
      if(istrat.eq.3) then
          rn1 = 0
          n2 = 0
          call dquadints_comb(eps,intype,npatches,norder,ipoly,ttype,
