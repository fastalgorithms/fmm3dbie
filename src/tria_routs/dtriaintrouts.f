...
c
     ...
     1         ndz,zpars,ndi,ipars,fval)
      ...
      call dgemm(transa,transb,nppols,ntarg0,nqpts,alpha_c,sigvals,
...
c
          call dgemv('n',nppols,npts,alpha_c,sigmatmp,nppols,fkervals,
     1       1,beta_c,cintvals(1,itarg),1)
        enddo
      enddo
...
c
          ...
          alpha_c = 1
          beta_c = 0
          call dgemm(transa,transb,nd,nppols,npts,alpha_c,
