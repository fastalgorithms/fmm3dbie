...
!$OMP END PARALLEL DO
      ...
      return
      end subroutine getnearquad_capillary_gs
!
!
!
!
...
!
      ...
      subroutine getnearquad_capillary_lapgs(npatches, norders, &
        ixyzs, iptype, npts, srccoefs, srcvals, &
        eps, zpars, iquadtype, nnz, row_ptr, col_ind, &
        iquad, rfac0, nquad, wnear)
!
!  Near-field quadrature for the Laplacian of the capillary wave
!  free-surface Green's function, Delta G_s (lapgshelmkern),
!  evaluated on-surface (targets = sources).
!
!  Input:  zpars(6): cubic roots zpars(1:3) and residues zpars(4:6)
!  Output: wnear(nquad): near-field quadrature corrections for Delta G_s
...
!$OMP END PARALLEL DO
      ...
      return
      end subroutine getnearquad_capillary_lapgs
!
!
!
!
