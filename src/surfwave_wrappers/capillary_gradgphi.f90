      ...
      subroutine getnearquad_capillary_gradgphi(npatches, norders, &
...
! replace kernels here      
      external gradxgphihelmkern
      external gradygphihelmkern
