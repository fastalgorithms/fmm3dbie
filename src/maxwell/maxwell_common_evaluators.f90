...
!$    real *8 omp_get_wtime      
      ...
      integer *8 nd, ntarg0, nmax, idim

      integer *8 i1, i2
      integer *8 ifj, ifm, ifrho, iftau
      integer *8 ife_current, ife_charge, ifh_current
      integer *8 ife, ifdive, ifcurle
