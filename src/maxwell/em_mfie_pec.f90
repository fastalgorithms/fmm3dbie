...
!  Last edited:
!
!  This file contains the following user callable routines for solving
!  Maxwell equations using the mfie integral represenation:
!
!    getnearquad_em_mfie_pec: routine for generating the near field
...
!
      ...
      integer *8 i,j,jpatch,jquadstart,jstart,ifdir
...
!
	...
	write (*,*) 'P0',P0
	call em_mfie_pec_FMM_targ(eps_FMM,zk,ns,srcvals,int(1,8),P0,wts,sol(1:ns),&
	 &sol(ns+1:2*ns),Ht1)
