...
c
c  * cumsum_long:
c      computes the cumulative sum of integer *8
c      
...
c     if tons of processors, allocate d2
      allocate(d2(maxth))
      call cumsum_long_para(n,a,b,maxth,d2)
      return

 200  continue

      call cumsum_long_para(n,a,b,lend,d)
      return
      
 300  continue
            
      call cumsum1_long(n,a,b)
      return
      
      end
c
c
      subroutine cumsum1_long(n,a,b)
c
c--------------------------
c  This subroutine computes the cumulative sum
c  (aka prefix sum aka scan) of the vector a and
...
c
      ...
      subroutine cumsum_long_para(n,a,b,nd,d)
c
c
c--------------------------
c  This subroutine computes the cumulative sum
...
c$OMP PARALLEL DEFAULT(none) SHARED(a,b,n,d)
c$OMP$ PRIVATE(i,isum,offset,id,nth)
