...
cc      call prin2('xyztarg=*',xyztarg,9)
      ...
      rfac= 3.0d0
      cintex(1,1) = 1.156374590854795d0 
      cintex(2,1) = 0.0942702604583580d0 
      cintex(3,1) = -0.239019699324178d0

      cintex(1,2) = 1.7158925715165438d0 
      cintex(2,2) = 0.588248265036294074d0 
      cintex(3,2) = -0.957021021711130743d0 
