...
c
      ...
      call dtriaints(eps,istrat,intype,npatches,norder,npols,isd,
     1      ndsc,srccoefs,ndim,ntarg,xyztarg,ifp,tmp,itargptr,
...
c
 4000 continue
      ...
      call dtriaints_wnodes(npatches,norder,npols,isd,ndsc,srccoefs,
