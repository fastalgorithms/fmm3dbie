...
!	  allocate(a_vect(npts),RHS_vect(npts))
      ...
      call get_RHS_h_neumann(xyz_in,npts,srcvals,zpars(1),rhs)
...
!      enddo
      ...
      call cpu_time(t1)
!C$      t1 = omp_get_wtime()      
      call h_neumann_solver(npatches,norders,ixyzs,iptype,npts,&
...
!
      call test_accuracy_h_neumann(eps,sigma,sigma2,zpars,npts,wts,srcvals,xyz_in,xyz_out)
