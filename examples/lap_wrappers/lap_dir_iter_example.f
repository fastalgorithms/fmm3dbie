...
c
      call l3d_slp(xyz_out,3,xyz_in,0,dpars,1,zpars,0,ipars,potex)
      pot = 0
      do i=1,npts
        call l3d_comb(srcvals(1,i),3,xyz_in,0,dpars,3,zpars,0,ipars,
     1     dtmp)
...
c
      ...
      do ipatch=1,npatches
        do j=1,npols
          i = (ipatch-1)*npols + j
          call l3d_sprime(xyzout,12,srcvals(1,i),0,dpars,1,zk,0,ipars,
     1       val)
