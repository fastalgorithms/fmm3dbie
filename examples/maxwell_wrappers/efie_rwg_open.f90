program efie_rwg_open
  ...
  print *
  print *
  write (*,*) 'loading geometry from fname: ', trim(fname)
  call open_gov3_geometry_mem(trim(fname), npatches_aux, npts_aux)
  ...
  call open_go3_4_rwg(trim(fname), npts_aux, npatches_aux, norder, npatches, &
       norders, ixyzs, &
