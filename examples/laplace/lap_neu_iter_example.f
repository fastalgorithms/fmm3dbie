...
c      
     ...
     1     ipars, rhs(i))
      ...
      call lap_s_neu_solver(npatches, norders, ixyzs, iptype, npts,
     1  srccoefs, srcvals, eps, numit, ifinout, rhs, eps_gmres,
...
c
     ...
     1    0, ipars, dtmp)
      ...
      uvs_targ(1) = 0
      uvs_targ(2) = 0
      call lap_s_neu_eval(npatches, norders, ixyzs, iptype,
     1  npts, srccoefs, srcvals, ndtarg, ntarg, xyz_targ, ipatch_id,
     2  uvs_targ, eps, sigma, pot)
