...
For solving the Helmholtz Dirichlet problem, we use the combined
...
For solving the Helmholtz Neumann problem, we use the right
preconditioned combined field representation:
