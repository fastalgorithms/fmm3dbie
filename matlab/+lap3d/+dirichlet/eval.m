...
% Call the layer potential evaluator
    mex_id_ = 'lap_comb_dir_eval_addsub(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i int[x], c i int[x], c i double[xx], c i double[x], c i int[x], c i double[x], c i int[x], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c i int[x], c i double[x], c i int[x], c i int[x], c i double[x], c i int[x], c i int[x], c io double[x])';
