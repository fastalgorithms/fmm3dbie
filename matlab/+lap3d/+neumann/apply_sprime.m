function p = apply_sprime(S,sigma,eps,opts)
%
%  lap3d.neumann.apply_sprime
...
mex_id_ = 'lpcomp_lap_s_neu_addsub(i int[x], i int[x], i int[x], i int[x], i int[x], i double[xx], i double[xx], i double[x], i int[x], i double[x], i int[x], i dcomplex[x], i int[x], i int[x], i int[x], i int[x], i int[x], i int[x], i int[x], i int[x], i double[x], i int[x], i int[x], i int[x], i double[xx], i double[x], i int[x], i double[x], i int[x], i double[x], i double[x])';
