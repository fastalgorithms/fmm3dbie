...
%
     switch lower(pde)
       ...
       case {'helmholtz', 'helm', 'h'}
         [densities, varargout{1:nargout-1}] = helm3d.solver(S, bc, rhs, ...
                                               eps, varargin{:});
       case {'stokes', 'stok', 's'}
         [densities, varargout{1:nargout-1}] = stok3d.solver(S, bc, rhs, ...
                                               eps, varargin{:});  
       case {'maxwell', 'em', 'm'}
         [densities, varargout{1:nargout-1}] = em3d.solver(S, bc, rhs, ...
                                               eps, varargin{:});  
