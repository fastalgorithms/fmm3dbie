function dens_int = interpolate_dens(obj, dens, ipatch_ids, uvs_targ)
% INTERPOLATE_DENS interpolates a density on surfer object 
%
% dens_int = interpolate(obj,dens,ipatch_id,uvs_targ) where dens_int is a 
...
npatch = length(upids);
dens_int = zeros(size(ipatch_ids));
