...
%
%  Syntax
%   pot = helm3d.impedance.eval(S,zpars,sigma,siksigma,eps)
%   pot = helm3d.impedance.eval(S,zpars,sigma,siksigma,eps,targinfo)
%   pot = helm3d.impedance.eval(S,zpars,sigma,siksigma,eps,targinfo,Q)
%   pot = helm3d.impedance.eval(S,zpars,sigma,siksigma,eps,targinfo,Q,opts)
%
