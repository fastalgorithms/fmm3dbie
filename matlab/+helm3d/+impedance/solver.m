function [sigma, siksigma, varargout] = solver(S, zpars, zlams, rhs, eps, opts)
%
%  helm3d.impedance.solver
%    Solve the helmholtz impedance boundary value problem
%
%  Syntax
%   [sigma, siksigma] = helm3d.impedance.solver(S,zpars,zlams,rhs,eps)
%   [sigma, siksigma] = helm3d.impedance.solver(S,zpars,zlams,rhs,eps,opts)
%
