...
%
%  Syntax
%   pot = helm3d.neumann.eval(S,densities,eps,zk,alpha)
%   pot = helm3d.neumann.eval(S,densities,eps,zk,alpha,targinfo)
%   pot = helm3d.neumann.eval(S,densities,eps,zk,alpha,targinfo,Q)
%   pot = helm3d.neumann.eval(S,densities,eps,zk,alpha,targinfo,Q,opts)
%
