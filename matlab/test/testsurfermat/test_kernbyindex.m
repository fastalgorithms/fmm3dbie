...
Acheck = byindex.kernbyindex(ii, jj, S, kern, eps, novers);
...
[Asmth2,novers2] = surfermat(srfrs, kerns, eps, opts_sm);
n2 = size(Asmth2, 1);
m2 = size(Asmth2, 2);
ii2 = randi(n2, 80, 1);
jj2 = randi(m2, 80, 1);

Acheck2 = byindex.kernbyindex(ii2, jj2, srfrs, kerns, eps, novers2);
...
Acheck3 = byindex.kernbyindex(ii3, jj3, S3, kern3,eps, {nover3});
...
nover_wrong = S3.norders(1)* ones(S3.npatches, 1);
Acheck_wrong = byindex.kernbyindex(ii3, jj3, S3, kern3, eps, {nover_wrong});
