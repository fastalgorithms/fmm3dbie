...
%
  ...
  mex_id_ = 'get_xyz_tensor_fourier_npat_mem(i double[xx], i int64_t[x], i int64_t[x], i double[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], io int64_t[x], io int64_t[x])';
[npatches, npts] = fmm3dbie_routs(mex_id_, coefs_use, m, nfp, scales, iort, nuv, norder, iptype, npatches, npts, muse, 3, 1, 1, 3, 1, 2, 1, 1, 1, 1);
  ...
  mex_id_ = 'get_xyz_tensor_fourier_npat(i double[xx], i int64_t[x], i int64_t[x], i double[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], io int64_t[x], io int64_t[x], io int64_t[x], io double[xx], io double[xx])';
