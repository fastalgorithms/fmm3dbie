...
%
  ...
  mex_id_ = 'get_ellipsoid_npat_mem(c i double[x], c i int64_t[x], c i double[x], c i int64_t[x], c i int64_t[x], c io int64_t[x], c io int64_t[x])';
[npatches, npts] = fmm3dbie_routs(mex_id_, abc, nabc, c0, norder, iptype, npatches, npts, 3, 3, 3, 1, 1, 1, 1);
  ...
  mex_id_ = 'get_ellipsoid_npat(c i double[x], c i int64_t[x], c i double[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c io int64_t[x], c io int64_t[x], c io int64_t[x], c io double[xx], c io double[xx])';
