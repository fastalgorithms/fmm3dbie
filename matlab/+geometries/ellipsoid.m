...
%
  ...
  mex_id_ = 'get_ellipsoid_npat_mem(i double[x], i int64_t[x], i double[x], i int64_t[x], i int64_t[x], io int64_t[x], io int64_t[x])';
[npatches, npts] = fmm3dbie_routs(mex_id_, abc, nabc, c0, norder, iptype, npatches, npts, 3, 3, 3, 1, 1, 1, 1);
  ...
  mex_id_ = 'get_ellipsoid_npat(i double[x], i int64_t[x], i double[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], io int64_t[x], io int64_t[x], io int64_t[x], io double[xx], io double[xx])';
