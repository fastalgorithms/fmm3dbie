...
% Extract arrays
    ...
    if (ntin > 0)
      iside = 1;
      mex_id_ = 'em_muller_trans_eval_oneside(c i double[x], c i dcomplex[xx], c i dcomplex[x], c i int[x], c i double[x], c i double[xx], c i int[x], c i double[xx], c i int[x], c io dcomplex[xx], c io dcomplex[xx])';
