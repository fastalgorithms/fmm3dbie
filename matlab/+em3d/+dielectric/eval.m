...
% Extract arrays
    ...
    if (ntin > 0)
      iside = 1;
      mex_id_ = 'em_muller_trans_eval_oneside(i double[x], i dcomplex[xx], i dcomplex[x], i int64_t[x], i double[x], i double[xx], i int64_t[x], i double[xx], i int64_t[x], io dcomplex[xx], io dcomplex[xx])';
