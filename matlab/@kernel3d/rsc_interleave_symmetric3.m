...
%     .type         = 'symmetric'
%     .nker         = 6
%     .row_inds     = (6,1) row indices of the upper-triangle entries
%     .col_inds     = (6,1) col indices of the upper-triangle entries
%     .sym_row_inds = (3,1) row indices of the off-diagonal reflected entries
%     .sym_col_inds = (3,1) col indices of the off-diagonal reflected entries
%     .sym_ker_inds = (3,1) which wnear row each reflected entry mirrors

% Upper triangle, column-major order (col varies slowest):
% (1,1),(1,2),(1,3),(2,2),(2,3),(3,3)
ri.type     = 'symmetric';
ri.nker     = 6;
ri.row_inds = [1; 1; 1; 2; 2; 3];
ri.col_inds = [1; 2; 3; 2; 3; 3];

% Off-diagonal reflected entries (lower triangle): (2,1),(3,1),(3,2)
% Each mirrors wnear row 2, 3, 5 respectively
ri.sym_row_inds = [2; 3; 3];
ri.sym_col_inds = [1; 1; 2];
ri.sym_ker_inds = [2; 3; 5];
