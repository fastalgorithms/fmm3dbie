...
%  
    ...
    if isfield(opts, 'filetype')
        ...
        ier = 0;
        ifiletype = 0;
        mex_id_ = 'MWF77_get_filetype(c i cstring[x], c io int[x], c io int[x])';
[ifiletype, ier] = fmm3dbie_routs(mex_id_, fnameuse, ifiletype, ier, 1000, 1, 1);
    ...
    ier = 0;
    mex_id_ = 'MWF77_multiscale_mesher(c i cstring[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[x], c i cstring[x], c io int[x])';
