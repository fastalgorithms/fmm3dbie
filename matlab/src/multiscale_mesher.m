...
%  
    ...
    if isfield(opts, 'filetype')
        ...
        ier = 0;
        ifiletype = 0;
        mex_id_ = 'MWF77_get_filetype(i cstring[x], io int64_t[x], io int64_t[x])';
[ifiletype, ier] = fmm3dbie_routs(mex_id_, fnameuse, ifiletype, ier, 1000, 1, 1);
    ...
    ier = 0;
    mex_id_ = 'MWF77_multiscale_mesher(i cstring[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[x], i cstring[x], io int64_t[x])';
