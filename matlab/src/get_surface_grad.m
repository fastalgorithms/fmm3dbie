...
% Extract arrays
    ...
    dp = zeros(nduse,npts);
    mex_id_ = 'get_surf_grad(c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i double[xx], c i double[xx], c i double[xx], c io double[xx])';
