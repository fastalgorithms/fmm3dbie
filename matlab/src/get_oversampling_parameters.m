...
%
    ...
    mex_id_ = 'get_far_order(c i double[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c i int[x], c i double[xx], c i int[x], c i int[x], c i double[xx], c i int[x], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i double[x], c io int[x], c io int[x])';
