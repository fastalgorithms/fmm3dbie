...
% Extract arrays
    ...
    dp = zeros(2,npts);
    mex_id_ = 'get_surf_grad(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i double[x], c io double[xx])';
[dp] = fmm3dbie_routs(mex_id_, nd0, npatches, norders, ixyzs, iptype, npts, srccoefs, srcvals, p, dp, 1, 1, npatches, npatp1, npatches, 1, n9, npts, n12, npts, npts, n2, npts);
    ...
    mex_id_ = 'get_surf_div(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i double[xx], c io double[x])';
