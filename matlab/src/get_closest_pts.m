...
[row_ptr, col_ind] = kern_routs(mex_id_, cms, npatches, rads, ndtarg, targs, ntarg, row_ptr, col_ind, n3, npatches, 1, npatches, 1, ndtarg, ntarg, 1, ntp1, nnz);
    ...
    for i=1:ntarg
        for j = 1:(iends(i) - istarts(i) + 1)
            ...
            mex_id_ = 'findnearsrfcpnt(i int64_t[x], i double[xx], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[xx], i double[xx], i double[x], i int64_t[x], i int64_t[x], io double[xx], io double[xx], io double[x], io int64_t[x])';
