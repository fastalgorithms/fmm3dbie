...
% Call the layer potential evaluator
    mex_id_ = 'stok_comb_vel_solver_guru(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i double[x], c i double[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c i double[x], c io int[x], c io double[x], c io double[x], c io double[xx])';
