function A = b2v_matgen_clamped(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
%  bh2d.b2v_matgen_clamped
%
%  Syntax
%   A = bh2d.b2v_matgen_clamped(S,zk,targinfo,eps)
%   A = bh2d.b2v_matgen_clamped(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
...
%    * zk: wavenumber (must be 0 for biharmonic)
...
%
    ...
    mex_id_ = 'getnearquad_bh2d_clamped(i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[xx], i double[xx], i int64_t[x], i int64_t[x], i double[xx], i int64_t[x], i double[xx], i double[x], i dcomplex[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[x], i int64_t[x], io double[xx])';
