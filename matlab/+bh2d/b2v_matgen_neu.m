function A = b2v_matgen_neu(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
%  bh2d.b2v_matgen_neu
%
%  Syntax
%   A = bh2d.b2v_matgen_neu(S,zk,targinfo,eps)
%   A = bh2d.b2v_matgen_neu(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
...
%
    ...
    mex_id_ = 'getnearquad_bh2d_v2b_neu(i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[xx], i double[xx], i int64_t[x], i int64_t[x], i double[xx], i int64_t[x], i double[xx], i double[x], i dcomplex[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[x], i int64_t[x], io double[x])';
