function A = gdn_matgen(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
%  bh2d.gdn_matgen
%
%  Syntax
%   A = bh2d.gdn_matgen(S,zk,targinfo,eps)
%   A = bh2d.gdn_matgen(S,zk,targinfo,eps,ipatch_id,uvs_targ)
%
%  Integral representation
%     pot = \int \partial_n G_S(r,r') \sigma(r') dA(r')
%
...
%
    ...
    mex_id_ = 'getnearquad_bh2d_gdn(i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[xx], i double[xx], i int64_t[x], i int64_t[x], i double[xx], i int64_t[x], i double[xx], i double[x], i dcomplex[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i int64_t[x], i double[x], i int64_t[x], io double[x])';
